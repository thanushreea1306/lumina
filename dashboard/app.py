...
[data-testid="stMainBlockContainer"] { padding-top: .35rem; max-width: 1480px; }
...
.lumina-tag {
    font-size: 1.42rem; font-weight: 900; letter-spacing: .1em; line-height: 1.22;
    color: var(--lumina-text); text-transform: uppercase;
    text-shadow: 0 2px 10px rgba(0,0,0,.4);
}
.lumina-statement {
    font-size: .88rem; color: var(--lumina-muted); margin-top: .4rem; letter-spacing: .02em;
}
.hero-phrase {
    font-size: .64rem; font-weight: 800; letter-spacing: .28em; text-transform: uppercase;
    color: var(--lumina-muted2); margin-top: .55rem; border-top: 1px solid var(--lumina-border);
    padding-top: .45rem; display: inline-block;
}
.hero-side { display: flex; flex-direction: column; align-items: flex-end; gap: .5rem; position: relative; z-index: 1; }
.status-pill {
    display: inline-flex; align-items: center; gap: .55rem;
    border: 1px solid var(--lumina-border2); border-radius: 999px;
    background: var(--lumina-card); padding: .4rem 1rem;
...
.hero-badges { display: flex; flex-direction: column; align-items: flex-end; gap: .35rem; }
...
.pipe {
    flex: 1 1 132px; min-width: 132px; padding: .8rem .8rem .65rem;
...
.risk-main {
    position: relative; z-index: 1; display: flex; align-items: center; gap: 1.4rem;
    padding: .9rem 1.5rem; flex-wrap: wrap;
}
.risk-left { flex: 1 1 250px; min-width: 235px; position: relative; }
.risk-eyebrow { font-size: .7rem; font-weight: 800; letter-spacing: .3em; text-transform: uppercase; color: var(--lumina-muted); }
.risk-level { font-size: 3.4rem; font-weight: 900; line-height: 1; letter-spacing: .04em; color: var(--lumina-text); margin-top: .3rem; }
...
.risk-score { font-family: "Cascadia Code", Consolas, monospace; font-size: 1.7rem; font-weight: 700; color: var(--lumina-text); margin-top: .35rem; }
.risk-score small { font-size: 1.05rem; color: var(--lumina-muted2); font-weight: 600; }
.risk-status { display: inline-block; margin-top: .5rem; font-size: .74rem; font-weight: 800; letter-spacing: .1em; text-transform: uppercase; color: var(--lumina-text); border: 1px solid var(--lumina-border2); border-radius: 999px; padding: .3rem .85rem; background: var(--lumina-card); }
.risk-action { margin-top: .45rem; font-size: .84rem; font-weight: 700; color: var(--lumina-muted); }
.risk-action b { color: var(--lumina-red); }
.risk-mid {
    flex: 0 1 240px; min-width: 195px; position: relative;
    display: flex; flex-direction: column; align-items: center; justify-content: center; gap: .35rem;
    border-left: 1px solid var(--lumina-border); border-right: 1px solid var(--lumina-border);
    padding: 0 1.2rem; align-self: stretch;
}
.risk-mid-title { font-size: .6rem; font-weight: 800; letter-spacing: .24em; text-transform: uppercase; color: var(--lumina-muted2); white-space: nowrap; }
.risk-signal {
...
.risk-right { flex: 1 1 250px; min-width: 235px; position: relative; display: flex; flex-direction: column; gap: .55rem; }
.risk-right-title { font-size: .6rem; font-weight: 800; letter-spacing: .24em; text-transform: uppercase; color: var(--lumina-muted2); }
...
.risk-note {
    font-size: .8rem; color: var(--lumina-muted); line-height: 1.5;
    border-left: 2px solid var(--lumina-red); padding: .15rem 0 .15rem .7rem;
}
.risk-kpi { display: flex; align-items: flex-start; gap: .5rem; font-size: .76rem; font-weight: 700; color: var(--lumina-text); line-height: 1.4; }
.kpi-dot { width: 6px; height: 6px; border-radius: 50%; background: var(--lumina-red); flex: 0 0 auto; margin-top: .32rem; }
.risk-hero-footer {
    position: relative; z-index: 1; display: flex; align-items: center; justify-content: space-between; gap: 1rem; flex-wrap: wrap;
    padding: .6rem 1.6rem; border-top: 1px solid var(--lumina-border); background: rgba(0,0,0,.22);
}
.risk-interv { font-size: .74rem; font-weight: 800; letter-spacing: .16em; text-transform: uppercase; color: var(--lumina-muted2); display: flex; align-items: center; gap: .6rem; white-space: nowrap; }
...
.intervention-head { padding: 1rem 1.2rem .5rem; position: relative; }
...
.intervention-steps { padding: .6rem 1.2rem 1.1rem; position: relative; }
...
/* ---------- delivery ---------- */
.delivery-card { border: 1px solid var(--lumina-border2); border-radius: 12px; background: var(--lumina-card); padding: .9rem 1rem; height: 100%; box-shadow: 0 8px 22px rgba(0,0,0,.22), inset 0 1px 0 rgba(255,255,255,.03); }
...
.empty-hero {
    ...
    background-size: 40px 40px, 40px 40px, auto;
    border: 1px solid var(--lumina-border2); border-radius: 16px;
    padding: 1.7rem 1.8rem; text-align: center;
    animation: luminaFade .4s ease both;
}
.empty-hero::before {
    content: ""; position: absolute; inset: 0; pointer-events: none;
...
.empty-brand { position: relative; z-index: 1; display: flex; flex-direction: column; align-items: center; gap: .75rem; }
...
.mode-card {
    ...
    padding: .95rem 1.2rem; height: 100%; position: relative;
    box-shadow: 0 8px 22px rgba(0,0,0,.22), inset 0 1px 0 rgba(255,255,255,.03);
...
.report-panel {
    ...
    border: 1px solid var(--lumina-border2); border-radius: 14px;
    padding: 1.2rem 1.6rem; margin-bottom: .9rem;
...
[data-testid="stRadio"] label[data-testid="stRadioOption"] {
    ...
    background: var(--lumina-card2); cursor: pointer; transition: all .15s ease; margin: 0;
}
[data-testid="stRadio"] label[data-testid="stRadioOption"]:hover { border-color: var(--lumina-muted); }
[data-testid="stRadio"] label[data-testid="stRadioOption"] div,
[data-testid="stRadio"] label[data-testid="stRadioOption"] div p {
    color: var(--lumina-text) !important;
    font-size: .76rem; font-weight: 700;
}
[data-testid="stRadio"] label[data-testid="stRadioOption"]:has(input:checked) {
    border-color: var(--lumina-red); background: var(--lumina-red);
}
[data-testid="stRadio"] label[data-testid="stRadioOption"]:has(input:checked) div,
[data-testid="stRadio"] label[data-testid="stRadioOption"]:has(input:checked) div p {
    color: #ffffff !important;
}
[data-testid="stRadio"] input { accent-color: var(--lumina-red); }

/* ---------- tabs ---------- */
[data-testid="stTabs"] { margin-top: .15rem; min-width: 0; max-width: 100%; }
[data-testid="stTabs"] > div { min-width: 0; max-width: 100%; }
[data-testid="stTabs"] [data-orientation="horizontal"] {
    display: flex; flex-wrap: wrap; gap: .35rem;
    border-bottom: 1px solid var(--lumina-border);
    padding: 0 0 .5rem; margin: 0 0 .35rem;
    min-width: 0; max-width: 100%; overflow-x: clip;
}
[data-testid="stTabs"] [data-testid="stTab"] {
    border: 1px solid transparent; border-radius: 999px;
    padding: .42rem .95rem; font-size: .74rem; font-weight: 800;
    letter-spacing: .08em; text-transform: uppercase;
    color: var(--lumina-muted2); background: transparent;
...
[data-testid="stTabs"] [data-testid="stTab"]:hover {
    color: var(--lumina-text); border-color: var(--lumina-border2);
}
[data-testid="stTabs"] [data-testid="stTab"][aria-selected="true"] {
    color: #ffffff; background: var(--lumina-red); border-color: var(--lumina-red);
}
[data-testid="stTabPanel"] { padding-top: .3rem; min-width: 0; max-width: 100%; }
[data-testid="stTabPanel"] > div { min-width: 0; max-width: 100%; }
[data-testid="stVerticalBlock"], [data-testid="stElementContainer"],
[data-testid="stHorizontalBlock"], [data-testid="stColumn"] { min-width: 0; max-width: 100%; }
[data-testid="stDataFrame"], [data-testid="stPlotlyChart"], [data-testid="stMetric"] { min-width: 0; max-width: 100%; }
...
def _to_body(signals: dict, include_telemetry: bool = True) -> dict:
    body = {key: signals.get(key, 0) for key in CALL_BEHAVIOR_FIELDS}
    body["day_of_week"] = signals.get("day_of_week", 2)
    if include_telemetry:
        body["extra_telemetry"] = {key: signals.get(key, 0) for key in TELEMETRY_FIELDS}
    return body
...
def risk_hero(level: str, score: float, intervention: dict = None, last: dict = None) -> None:
    ...
    explanation = (last or {}).get("explanation", "")
    exp_note = f'<div class="risk-note">{explanation}</div>' if explanation else ""
    factors = (last or {}).get("factors") or []
    kpi_rows = "".join(
        f'<div class="risk-kpi"><span class="kpi-dot"></span>{item}</div>'
    ...
    st.markdown(
        ...
        <div class="risk-hero {level}">
            ...
            <div class="risk-main">
                ...
                <div class="risk-mid">
                    <div class="risk-mid-title">Fused Score Gauge</div>
                    <div class="gauge-wrap">{_gauge_svg(score, color)}</div>
                </div>
                <div class="risk-right">
                    {interv_line}
                    {exp_note}
                    <div class="risk-right-title">Key Indicators</div>
                    {kpi_rows}
                </div>
            </div>
        </div>
...
def risk_evolution_chart(timeline: list) -> None:
    ...
    if _HAS_PLOTLY:
        ...
        st.line_chart(fallback.set_index("Time (min)"), height=300)
...
tab_overview, tab_pipeline, tab_evidence, tab_intervention, tab_report, tab_incidents = st.tabs(
    [
        "OVERVIEW",
        "RISK PIPELINE",
        "EVIDENCE & TIMELINE",
...
with tab_pipeline:
    if timeline:
        # ---------- 03 · LIVE RISK & DECISION PIPELINE ----------
        _section(
            "03",
    ...
    if timeline:
        ...
        st.markdown(
            ...
            <div class="report-panel">
                ...
                <div class="report-logo logo-tile">{_logo_img(56)}</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
